...
# ref :http://a-little-book-of-r-for-bayesian-statistics.readthedocs.org/en/latest/src/bayesianstats.html

# We will try to understnd the basic principle of baysian infernece by considering
# prior , then estimating likelihood and finding posterior- depending upon the data given.

## here are three prior estimations that we believe, we will try to find the best beta distribution 
## parameters that will fit our estimations
...
quantile3 <- list(p=0.00001,x=0.60) # we believe the 0.001st percentile of the prior is 0.60
 ...
 findBeta <- function(quantile1,quantile2,quantile3)
  {
	library("LearnBayes") # this is the basic library for baysian stats
...
LikelihoodBySurvey <- function(successes,total)
{
